export const HomeIcon = ({className,width='2rem',height='2rem',fill='#262626'}) => (
...
export const MessageIcon = ({className,width='2rem',height='2rem',fill='#262626'}) => (
    <svg  className={className}  
          fill={fill} 
          height={height} 
          width={width}
...
export const CircleIcon = ({className,width='2rem',height='2rem',fill='#262626'}) => (
    <svg  className={className}  
          fill={fill} 
          height={height} 
          width={width}
...
export const CompassIcon = ({className,width='2rem',height='2rem',fill='#262626'}) => (
    <svg  className={className}  
          fill={fill} 
          height={height} 
          width={width}
...
export const TymIcon = ({className,width='2rem',height='2rem',fill='#262626'}) => (
    <svg  className={className}  
          fill={fill} 
          height={height} 
          width={width}
...
export const SearchIcon = ({className}) => (
    <svg  className={className} 
          ...
          role="img" 
          viewBox="0 0 24 24" >
       <path d="M19 10.5A8.5 8.5 0 1110.5 2a8.5 8.5 0 018.5 8.5z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="16.511" x2="22" y1="16.511" y2="22"></line>
    </svg>
)
